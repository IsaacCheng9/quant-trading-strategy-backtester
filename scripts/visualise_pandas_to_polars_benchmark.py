...
def visualise_benchmark_times(pandas_csv: str, polars_csv: str) -> None:
    """
...
if __name__ == "__main__":
    M1_MAX_PANDAS_CSV_PATH = "resources/m1_max_pandas_pairs_trading_with_optimisers.csv"
    M1_MAX_POLARS_CSV_PATH = "resources/m1_max_polars_pairs_trading_with_optimisers.csv"
    visualise_benchmark_times(M1_MAX_PANDAS_CSV_PATH, M1_MAX_POLARS_CSV_PATH)
